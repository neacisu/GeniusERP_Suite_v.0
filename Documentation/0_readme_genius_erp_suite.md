...
| **F1** | *Core Platform*                      | Genius Shell UI, Admin Core (Setări & RBAC), Worker Registry API, Base Workers     | `5_roadmap_f_1_1_shell_gateway.md`, `6_roadmap_f_1_2_admin_core.md`                                 |
